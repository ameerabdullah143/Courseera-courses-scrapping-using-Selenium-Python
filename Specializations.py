...
for i in range(1,66):
    driver.get('https://www.coursera.org/search?page='+str(i)+'&index=prod_all_launched_products_term_optimization_aa_test&entityTypeDescription=Specializations')
    if (i==1):
        time.sleep(5)
    time.sleep(5)
...
coursera_df.to_csv('Specializations.csv')
