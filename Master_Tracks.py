...
for i in range(1,4):
    driver.get('https://www.coursera.org/search?query=mastertrack&page='+str(i)+'&index=prod_all_launched_products_term_optimization_aa_test&entityTypeDescription=MasterTrack%C2%AE%20Certificates')
    time.sleep(5)
...
coursera_df.to_csv('Master Tracks.csv')
